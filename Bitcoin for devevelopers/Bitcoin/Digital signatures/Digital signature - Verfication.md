To verify you need to generate $RandomPart$ and the $signature$ to proof one holds [[Bitcoin for devevelopers/Bitcoin/Digital signatures/Digital signature - Creation#Private Key]]
